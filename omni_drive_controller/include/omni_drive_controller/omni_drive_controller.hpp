...
#include "omni_drive_controller_parameters.hpp"
...
protected:
  ...
  std::vector<WheelHandle> registered_wheel_handles_;  // front_left, front_right, rear_left, rear_right

  // Parameters from ROS for omni_drive_controller
  ...
  // speed limiters
  SpeedLimiter limiter_x_linear_;
  SpeedLimiter limiter_y_linear_;
...
#endif  // OMNI_DRIVE_CONTROLLER__OMNI_DRIVE_CONTROLLER_HPP_

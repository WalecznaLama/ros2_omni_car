 ...
 * Author: Paul Mathieu
 * 
 * Omni drive: Rafal Krynski
 */

#ifndef OMNI_DRIVE_CONTROLLER__ODOMETRY_HPP_
#define OMNI_DRIVE_CONTROLLER__ODOMETRY_HPP_
...
public:
  ...
  double getLinear() const { return std::sqrt(linear_x_ * linear_x_ + linear_y_ * linear_y_); }
  double getAngular() const { return angular_; }

  void setWheelParams(double wheel_separation, double wheel_track, double wheel_radius);
...
// \note The versions conditioning is added here to support the source-compatibility with Humble
  ...
  double wheel_track_; // Distance between front and back wheels
...
#endif  // OMNI_DRIVE_CONTROLLER__ODOMETRY_HPP_
